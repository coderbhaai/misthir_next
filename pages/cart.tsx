...
import {Box,Grid,TextField,Typography,RadioGroup,FormControlLabel,Radio,Button,Container} from "@mui/material";
            ...
            <Grid container spacing={4}>
              ...
              <Grid  size={4}>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid size={12}><TextField label="Door code" variant="outlined" fullWidth sx={{ "& .MuiOutlinedInput-root": { borderRadius: "30px" } }} /></Grid>
                </Grid>
              </Grid>
              <Grid size={4}>
