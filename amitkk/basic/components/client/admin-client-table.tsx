...
import { ClientProps, MediaProps } from '@amitkk/basic/types/page';
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role='checkbox' selected={selected}>
        ...
        <TableCell><UserRow row={row as unknown as UserRowProps}/><br/>{row.role}</TableCell>
        <TableCell><MediaImage media={row.media_id as MediaProps}/></TableCell>
        <TableCell><StatusSwitch id={row._id.toString()} status={row.status} modelName="Client"/></TableCell>
