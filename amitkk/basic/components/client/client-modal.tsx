...
import type {DataProps} from '@amitkk/basic/components/client/admin-client-table';
    ...
    <CustomModal open={open} handleClose={handleCloseModal} title={title}>
      <form onSubmit={handleSubmit} style={{ maxHeight: "90vh", overflowY: "auto" }}>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2, width: "100%" }}>
          <TextField label="Client Name" variant="outlined" value={formData.name} name="name" fullWidth onChange={handleChange} required/>
          <TextField label="Client Email" variant="outlined" value={formData.email} name="email" fullWidth onChange={handleChange} required/>
          <TextField label="Client Phone" variant="outlined" value={formData.phone} name="phone" fullWidth onChange={handleChange} required/>
          <FormControl sx={{ width: "100%" }}>
            <InputLabel id="role-label">Role <span style={{ color: "red" }}>*</span></InputLabel>
