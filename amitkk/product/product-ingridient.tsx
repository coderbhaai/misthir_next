...
export function AdminIngridient(){
    ...
    return(
        <AdminTableLayout<DataProps>
            title="Ingridients" addButtonLabel="New Ingridient" onAddNew={() => setOpen(true)} filterData={filterData} onFilterData={setFilterData} table={{ ...table, emptyRows: (totalRows: number) => emptyRows(table.page, table.rowsPerPage, totalRows)  }} data={dataFiltered}
            head={
...
export default withAuth(AdminIngridient);