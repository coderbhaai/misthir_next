...
import { WebsitePortfolioProps } from '@amitkk/agency/types';
...
export interface DataProps extends WebsitePortfolioProps {
  function: string;
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role='checkbox' selected={selected}>
        ...
        <TableCell><StatusSwitch id={row._id.toString()} status={row.status} modelName="Website"/></TableCell>
