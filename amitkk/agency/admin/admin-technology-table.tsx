...
import { TechnologyProps } from '@amitkk/agency/types';
import { MediaProps } from '@amitkk/basic/types/page';

export interface DataProps extends TechnologyProps {
  function: string;
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role='checkbox' selected={selected}>
        ...
        <TableCell><StatusSwitch id={row._id.toString()} status={row.status} modelName="Technology"/></TableCell>
