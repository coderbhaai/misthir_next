...
import { ServiceProps } from '@amitkk/agency/types';
import { MediaProps } from '@amitkk/basic/types/page';

export interface DataProps extends ServiceProps {
  function: string;
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role='checkbox' selected={selected}>
        ...
        <TableCell><StatusSwitch id={row._id.toString()} status={row.status} modelName="Service"/></TableCell>
