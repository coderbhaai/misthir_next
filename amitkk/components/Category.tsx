...
const items = [
  ...
  { img: "/images/cake3.jpeg", title: "Chocolate Cupcake", titleamt: "$100", weight: "2 PCS", type: "Mini Delight", category: "Cupcake", amt: "$100" },
  { img: "/images/cake3.jpeg", title: "Chocolate Brownie", titleamt: "$150", weight: "3 PCS", type: "Fudgy Brownie", category: "Brownie", amt: "$150" },
  { img: "/images/cake3.jpeg", title: "Butter Biscuit", titleamt: "$80", weight: "200 GM", type: "Crunchy Biscuit", category: "Biscuit", amt: "$80" },
  { img: "/images/cake3.jpeg", title: "Red Velvet Pastry", titleamt: "$120", weight: "1 PCS", type: "Soft Pastry", category: "Pastry", amt: "$120" },
  { img: "/images/cake3.jpeg", title: "Garlic Bread", titleamt: "$90", weight: "1 PCS", type: "Fresh Bread", category: "Bread", amt: "$90" },
];
          ...
          {filteredItems.map((item, index) => (
            <Grid key={index}>
              <Box
                ...
                <Box className="defaultText" sx={{ position: "absolute", bottom: 0, left: 0, right: 0, color: "#000", p: 3, textAlign: "center", transition: "all 0.3s ease", backdropFilter: "blur(6px)",  WebkitBackdropFilter: "blur(2px)",}}>
                ...
                <Box className="hoverContent" sx={{position: "absolute",inset: 0,bgcolor: "rgba(0,0,0,0.6)",display: "flex",flexDirection: "column",justifyContent: "center",alignItems: "center",opacity: 0,transform: "translateY(20px)",transition: "all 0.3s ease",color: "#fff", }}>
                  ...
                  <Button  variant="contained"  sx={{ backgroundColor: "#ffff", color:"black", borderRadius: 10,px: 4,}}>Buy Now</Button>
                </Box>
              </Box>
            </Grid>
          ))}
