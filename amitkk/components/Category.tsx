    ...
    <>
      <Box sx={{py: 6}}>
        <Stack direction="row" spacing={1} justifyContent="center" mb={3}>
          ...
          <Button variant={filter === "Cake" ? "contained" : "outlined"} onClick={() => setFilter("Cake")}>Cake</Button>
          <Button variant={filter === "Cupcake" ? "contained" : "outlined"} onClick={() => setFilter("Cupcake")}>Cupcake</Button>
          <Button variant={filter === "Brownie" ? "contained" : "outlined"} onClick={() => setFilter("Brownie")}>Brownie</Button>
          <Button variant={filter === "Biscuit" ? "contained" : "outlined"} onClick={() => setFilter("Biscuit")}>Biscuit</Button>
          <Button variant={filter === "Pastry" ? "contained" : "outlined"} onClick={() => setFilter("Pastry")}>Pastry</Button>
          <Button variant={filter === "Bread" ? "contained" : "outlined"} onClick={() => setFilter("Bread")}>Bread</Button>
      </Stack>
            ...
            <Grid key={index}>
              ...
              >
                ...
                <Box
                  ...
                  <Button  variant="contained"  sx={{  backgroundColor: "#028a9cff",  "&:hover": { backgroundColor: "#155b70ad" },  borderRadius: 10,  px: 4,   }}>
                              Buy Now</Button>
                </Box>
              </Box>
            </Grid>
